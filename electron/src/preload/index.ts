...
const api: FatCatAPI = {
  ...
  approveAction: (proposalId) => ipcRenderer.invoke(FATCAT_INVOKE_CHANNELS.approveAction, proposalId),
  denyAction: (proposalId) => ipcRenderer.invoke(FATCAT_INVOKE_CHANNELS.denyAction, proposalId),
