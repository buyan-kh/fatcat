...
struct NativeDomainTests {
    @Test func petStatesUseTheRealAvatarAnimationKeys() {
        ...
        #expect(FatCatState.understanding.animationKey == "thinking")
        #expect(FatCatState.askingPermission.animationKey == "listening")
        #expect(FatCatState.acting.animationKey == "working")
        #expect(FatCatState.celebrating.animationKey == "celebrate")
        #expect(FatCatState.suspicious.animationKey == "suspicious")
        #expect(FatCatState.sleeping.animationKey == "sleeping")
    }

    @Test func celebrationRequiresVerifiedSuccess() {
        var machine = FatCatStateMachine()
    ...
    @Test func petPositionPersistsAndClampsToVisibleScreen() {
        let suiteName = "FatCatTests-\(UUID().uuidString)"
